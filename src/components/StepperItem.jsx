...
function StepperItem({stepNumber, stepLabel, active}) {
  return (
    <div className='flex gap-5 items-center'>
        <button className={`${active ? ACTIVE_CLASSES : INACTIVE_CLASSES} transition-colors font-bold rounded-full w-10 h-10 flex-shrink-0 hover:text-gray-900 hover:bg-primary-light`}>{stepNumber}</button>
